-- CreateEnum
CREATE TYPE "PostCategory" AS ENUM ('GENERAL', 'EXPERIENCES', 'QUESTIONS', 'SUPPORT', 'VICTORIES', 'RESOURCES', 'DISCUSSION');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SPAM', 'HARASSMENT', 'HATE_SPEECH', 'MISINFORMATION', 'SELF_HARM', 'INAPPROPRIATE', 'OTHER');
